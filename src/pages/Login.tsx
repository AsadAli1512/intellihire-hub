      ...
      <div className="hidden lg:flex flex-1 hero-gradient items-center justify-center p-8">
        <div className="max-w-lg text-center">
          ...
          <p className="text-primary-foreground/70 text-lg">
            Join thousands of companies transforming their hiring process with intelligent interviews.
          </p>
          <div className="mt-8 flex justify-center gap-4">
            <div className="px-4 py-2 rounded-lg bg-primary-foreground/10 text-primary-foreground text-sm">
              50K+ Interviews
            </div>
            <div className="px-4 py-2 rounded-lg bg-primary-foreground/10 text-primary-foreground text-sm">
              2K+ Companies
